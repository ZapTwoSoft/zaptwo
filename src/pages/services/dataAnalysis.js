...
const mockData = {
  title: "Data Analysis",
  subtitle:
    "ZapTwo is a full-service data analysis company that specializes in helping businesses make better decisions with their data. We have a team of experienced data analysts who are experts in a variety of data analysis techniques, including data mining, machine learning, and statistical analysis.",
  paragraphOne:
    "We understand that every business has different data needs, and that's why we take the time to get to know your business and your data before we start working with you. We work with you to understand your business goals and then develop a data analysis strategy that is tailored to your specific needs.\n" +
  ...
  paragraphTwo:
    "We are committed to providing our clients with the highest quality data analysis services. We are confident that we can help you make better decisions with your data.\n" +
  ...
  points: [
    "We have a team of experienced data analysts who are experts in a variety of data analysis techniques.",
  ...
  paragraphThree:
    "We are confident that we can help you make better decisions with your data. Contact us today to learn more about our data analysis services.",
}
