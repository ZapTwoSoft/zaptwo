...
const mockData = {
  ...
  subtitle:
    "ZapTwo is a full-service SEO company that specializes in helping businesses improve their search engine rankings. We have a team of experienced SEO experts who are experts in a variety of SEO techniques, including keyword research, on-page optimization, and off-page optimization.",
  paragraphOne:
    "We understand that every business is different, and that's why we take the time to get to know your business and your needs before we start working on your SEO. We work with you to create an SEO strategy that is tailored to your specific business goals.",
  features: [
    {
  ...
  paragraphTwo:
    "We are committed to providing our clients with the highest quality SEO services. We are confident that we can help you improve your search engine rankings and drive more traffic to your website.\n" +
  ...
  points: [
    "We have a team of experienced SEO experts who are experts in various SEO techniques.",
  ...
  paragraphThree:
    "If you are looking for an SEO company that can help you improve your search engine rankings and drive more traffic to your website, then contact ZapTwo today.",
}
